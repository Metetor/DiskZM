        ...
        void bulk_load_disk(T *_keys, P *_values, int _size, int *r_block = nullptr, int *r_offset = nullptr) {
            ...
            while (!s.empty()) {
                ...
                if (end - begin == 2) {
                    ...
                    printf("slope:%f,key:%d,intercept:%f",node.slope,keys[0],node.intercept);
